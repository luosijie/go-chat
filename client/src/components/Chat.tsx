import { MessageSquareMore, Send, Smile } from 'lucide-react'
        ...
        <div className="flex flex-col w-full h-full relative">
            {
                ...
                <>
                    ...
                    <div className="flex gap-2 items-center px-2 border-b h-14">
                        ...
                        <span className="font-bold text-lg">{ current?.contact.username }</span>
                    </div> 
                ...
                <Empty text='Starting a chat ...' Icon={MessageSquareMore}/>
            }
        </div>
    )
}
